...
class CTexture : public CResourceDirectories
{
public:
	CTexture(std::string fileName, CWindow* window); // only takes the file name, default texture directory is used
	~CTexture();
